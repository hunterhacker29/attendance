        ...
        <div>
            ...
            <div className="container" id="home">
                    ...
                    <form action="" className="login-form" autoComplete="off">
                        <div className="login-content">
                            ...
                            <div className="bg-grey">
                                <div className="sing-up">Don't have an account? <Link to="/signup" className="text-link" id="sign-up">Sign up</Link></div>
                            </div>
                ...
                <div className="login-right">
                    <img src="https://i.pinimg.com/564x/34/51/70/3451702994f520e205a957878ce964e2.jpg" alt="Data Arranging" /> {/* Make sure the image path is correct */}
                </div>
            </div>
